package com.example.zhuanchu.thread;
...
public class ThreadUtil {
    ...
    public static ExecutorService buildDownloadBatchThreadPool(int threadSize) {
        ...
        BlockingQueue blockingQueue = new ArrayBlockingQueue<>(threadSize);

        ThreadPoolExecutor threadPoolExecutor =
                new ThreadPoolExecutor(threadSize, threadSize,
                        keepAlive, TimeUnit.SECONDS, blockingQueue,factory);
